...
namespace Leap.Unity.Examples {
    ...
    public float minProductoVectorial;
    public float maxProductoVectorial;
    ...
    void Update() {
      ...
      if (GetIsFacingCamera(toFaceCamera, cameraToFace, _isFacingCamera ? minProductoVectorial : maxProductoVectorial) != _isFacingCamera) {
