...
public class Electric : MonoBehaviour
{
    ...
    private void Start ()
    {
        gameObject.transform.parent = null; //Se queda por ahi volando en el inspector, mejor que no tenga padre;
    ...
    {
        //transformPointA.position = new Vector3((Left.Position.x + Right.Position.x) / 2, (Left.Position.y + Right.Position.y) / 2, (Left.Position.z + Right.Position.z) / 2);
